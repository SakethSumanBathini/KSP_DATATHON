...
TABLES = {
    ...
    "ChargesheetDetails": (
        """CREATE TABLE ChargesheetDetails (CSID INTEGER PRIMARY KEY, CaseMasterID INTEGER,
            csdate TEXT, cstype TEXT, PolicePersonID INTEGER,
            FOREIGN KEY(CaseMasterID) REFERENCES CaseMaster(CaseMasterID))""",
        "ChargesheetDetails.csv", ["CSID","CaseMasterID","csdate","cstype","PolicePersonID"]),
    "ComplainantDetails": (
...
LOAD_ORDER = ["State","District","UnitType","Unit","CaseCategory","GravityOffence","CrimeHead",
    ...
    "ComplainantDetails","ArrestSurrender","ActSectionAssociation","ChargesheetDetails"]
